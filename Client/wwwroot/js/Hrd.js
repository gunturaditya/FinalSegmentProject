console.log("TES1")
$.ajax({
    url: "https://localhost:7167/api/Student/StudentTrueAproval"
}).done((res) => {
    console.log(res)
});
...
$(document).ready(function () {
    ...
    $.ajax({
        url: "https://localhost:7167/api/Student/CountNullAproval",
        type: "Get",
        headers: {
            'Content-Type': 'application/json'
        },
    ...
    $.ajax({
        url: "https://localhost:7167/api/Student/CountTrueAproval",
        type: "Get",
        headers: {
            'Content-Type': 'application/json'
        },
    ...
    table.DataTable({
        "ajax": {
            "url": "https://localhost:7167/api/Student/StudentNullAproval",
            "dataType": "json",
            "dataSrc": "data",
        },
        columns: [
            ...
            { data: "phoneNumber" },
            {
                ...
                render: (data, type, row) => {
                    ...
                    <a class="btn btn-info mt-1" href="PDFViewerNewTab?fileName=${row.document}" target="_blank">View CV</a>`                    
                }
            },
        ]
    ...
    table2.DataTable({
        ...
        "ajax": {
            "url": "https://localhost:7167/api/Student/StudentFalseAproval",
            "dataType": "json",
            "dataSrc": "data",
...
function getBynik(stringUrl) {
    $.ajax({
        url: "https://localhost:7167/api/Student/student/" + stringUrl
    }).done((res) => {
        console.log(res);
        let temp = "";
...
function getNimStudent(stringUrl) {
    $.ajax({
        url: "https://localhost:7167/api/Student/StudentByNim/" + stringUrl
    }).done((res) => {
        //console.log(res);
        $.each(res.data, (key, val) => {
...
function Aproval() {
    ...
    $.ajax({
        url: "https://localhost:7167/api/Student/AprovalTrue/" + nim,
        type: "put",
        headers: {
            'Content-Type': 'application/json'
        },
...
function NoAproval() {
    ...
    $.ajax({
        url: "https://localhost:7167/api/Student/AprovalFalse/" + nim,
        type: "put",
        headers: {
            'Content-Type': 'application/json'
        },
...
$(document).ready(function () {
    $.ajax({
        url: "https://localhost:7167/api/Department"
    }).done((res) => {
        console.log(res)
        let temp = "";
...
function getdepart(value) {
    $.ajax({
        url: "https://localhost:7167/api/Employee/employe/"+value
    }).done((res) => {
        console.log(res)
        let temp = "";
...
function SimpanStatus() {
    ...
    $.ajax({
        url: ("https://localhost:7167/api/Status"),
        type: "POST",
        headers: {
            'Content-Type': 'application/json'
        },
...
function DeleteStudent(stringUrl) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: " https://localhost:7167/api/AccountStudent/student/" + stringUrl,
                type: "DELETE",
                headers: {
                    'Content-Type': 'application/json'
                },
...
let url = "https://localhost:7167/api/Student/StudentChart";
